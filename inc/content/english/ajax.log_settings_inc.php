...
<table id="results_table" class="datatable table table-striped table-responsive table-condensed">
 <thead>
  <th>Log Content</th>
...
<tbody>
 <tr>
  ...
  <?php } ?>
    <td>
      <?=date(TIMESTAMP_FORMAT,strtotime($q2a['last_updated']))?>
    </td>
 </tr>
</tbody>
<?php
